...
import VotingStep from '@/containers/VotingStep';
...
export default function TaskVotedDetailSider({
  isSimple,
  isVoting,
  ...
  return (
    <div className='flex flex-col'>
      <div className={clsx({ hidden: isSimple })}>
        <div className='flex w-[520px] items-end justify-between'>
          <div className='relative flex flex-shrink-0 flex-grow-0 flex-col items-start justify-start gap-1'>
          ...
          <div className='flex flex-shrink-0 flex-grow-0 items-end justify-start gap-4'>
            <div className='relative flex flex-shrink-0 flex-grow-0 items-start justify-start gap-1'>
              <a href='/tasks/1' target='_blank'>
